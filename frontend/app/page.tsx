...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-x-hidden">
      ...
      <main className="relative container mx-auto px-4 sm:px-6 pt-8 sm:pt-14 lg:pt-20 pb-0 max-w-6xl">
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tighter leading-[1.05] mb-4 sm:mb-6 max-w-4xl mt-2 sm:mt-4 px-4">
            ...
            <motion.span
              className="block bg-gradient-to-r from-primary via-primary/90 to-amber-400 bg-clip-text text-transparent"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="relative w-full pt-12 lg:pt-20 pb-8 lg:pb-12 bg-muted/40 overflow-hidden">
        <div className="w-full px-[2vw]">
          <div className="max-w-[2000px] mx-auto">
            <div className="relative bg-[#1c1608] rounded-3xl overflow-hidden">
            ...
            <div className="text-white space-y-6 order-1 lg:order-2">
              ...
              <p className="text-base sm:text-lg text-[#fef3c7]/80 leading-relaxed max-w-xl">
      ...
      {/* Footer */}
      <footer className="bg-[#1c1608] text-[#fef3c7] py-12 sm:py-16">
        <div className="container mx-auto px-4 sm:px-6 max-w-6xl">
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-10 sm:mb-12">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <p className="text-[#f5c842]/70 text-sm leading-relaxed">
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li><Link href="/agent-builder" className="text-[#f5c842]/70 hover:text-[#fef3c7] transition-colors text-sm">Agent Builder</Link></li>
                <li><Link href="/my-agents" className="text-[#f5c842]/70 hover:text-[#fef3c7] transition-colors text-sm">My Agents</Link></li>
                <li><Link href="/marketplace" className="text-[#f5c842]/70 hover:text-[#fef3c7] transition-colors text-sm">Marketplace</Link></li>
                <li><Link href="/contract-explorer" className="text-[#f5c842]/70 hover:text-[#fef3c7] transition-colors text-sm">Contract Explorer</Link></li>
                <li><Link href="/api-docs" className="text-[#f5c842]/70 hover:text-[#fef3c7] transition-colors text-sm">API Docs</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li><Link href="/api-docs" className="text-[#f5c842]/70 hover:text-[#fef3c7] transition-colors text-sm">API Documentation</Link></li>
                <li><a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-[#f5c842]/70 hover:text-[#fef3c7] transition-colors text-sm">GitHub</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li><a href="mailto:contact@inflow.com" className="text-[#f5c842]/70 hover:text-[#fef3c7] transition-colors text-sm">Contact</a></li>
              </ul>
            </div>
          </div>

          {/* Bottom Bar */}
          <div className="border-t border-[#3a2e10] pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-[#f5c842]/70 text-xs sm:text-sm text-center sm:text-left">
              © 2025 InFlow. All rights reserved.
            </p>
            <div className="flex gap-5 sm:gap-6">
              <a href="#" className="text-[#f5c842]/70 hover:text-[#fef3c7] transition-colors">
